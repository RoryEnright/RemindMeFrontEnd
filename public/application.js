...
/***/ (function(module, exports, __webpack_require__) {
	...
	var reminderEvents = __webpack_require__(12);
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://peaceful-reef-56230.herokuapp.com'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getFormFields = __webpack_require__(11);
	var reminderApi = __webpack_require__(13);
	var reminderUi = __webpack_require__(14);

	var onCreateReminder = function onCreateReminder(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  reminderApi.createReminder(data).then(reminderUi.createReminderSuccess).catch(reminderUi.createReminderFailure);
	};

	var onGetReminders = function onGetReminders(event) {
	  event.preventDefault();
	  reminderApi.getReminders().then(reminderUi.getRemindersSuccess).catch(reminderUi.getRemindersfailure);
	};

	var onDeleteReminder = function onDeleteReminder(event) {
	  event.preventDefault();
	  var id = $(event.target).attr('data-id');
	  reminderApi.deleteReminder(id).then(reminderUi.deleteRemindersuccess).catch(reminderUi.deleteReminderFailure);
	};
	...
	var onUpdateReminder = function onUpdateReminder(event) {
	  ...
	  var data = getFormFields(event.target);
	  var id = $(event.target).attr('data-id');
	  reminderApi.updateReminder(data, id).then(reminderUi.updateReminderSuccess).catch(reminderUi.updateReminderFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getReminders = function getReminders(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/reminders',
	    method: 'GET',
	    headers: {
	...
	var deleteReminder = function deleteReminder(data) {
	  return $.ajax({
	...
	var updateReminder = function updateReminder(data, id) {
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showRemindersTemplate = __webpack_require__(15);
	var updateRemindersTemplate = __webpack_require__(35);
	var deleteRemindersTemplate = __webpack_require__(36);
	var reminderApi = __webpack_require__(13);
	var getFormFields = __webpack_require__(11
	// const reminderEvents = require('./remind-events.js')
	  ...
	  reminderApi.getReminders().then(getRemindersSuccess).catch(getRemindersfailure);
	};
	...
	var onDeleteReminder = function onDeleteReminder(event) {
	  event.preventDefault();
	  var id = $('.delete-reminder').prev().attr('data-id'
	  // $('.remove').on('click', function () {
	  //   $('.delete-update').hide()
	  // })
	  );reminderApi.deleteReminder(id).then(deleteRemindersuccess).catch(deleteReminderFailure);
	};

	var deleteRemindersuccess = function deleteRemindersuccess(data) {
	...
	var onUpdateReminder = function onUpdateReminder(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  var id = $('.update-reminder').prev().attr('data-id');
	  reminderApi.updateReminder(data, id).then(updateReminderSuccess).catch(updateReminderFailure);
	};
	...
	var getRemindersSuccess = function getRemindersSuccess(response) {
	  var showRemindersHtml = showRemindersTemplate({ reminders: response.reminders });
	  $('.content').empty();
	...
	var deleteForm = function deleteForm(event) {
	  var deleteReminderHtml = deleteRemindersTemplate;
	...
	var updateForm = function updateForm(event) {
	  var updateReminderHtml = updateRemindersTemplate;
	  $(event.target).after(updateReminderHtml);
	  $('.update').off();
	  $('.update-reminder').on('submit', onUpdateReminder);
	};

	var getRemindersfailure = function getRemindersfailure() {
	  $('#message').text('Please try again');
	};
	...
	module.exports = {
	  ...
	  getRemindersSuccess: getRemindersSuccess,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n<ul data-id=\""
	    ...
	    + "</li>\n\n  <li>"
	    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.day : stack1),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams),"inverse":container.program(8, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "</li>\n\n  <li>"
	    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.when : stack1),{"name":"if","hash":{},"fn":container.program(10, data, 0, blockParams),"inverse":container.program(12, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "</li>\n\n<li><button class=\"remove\" class=\"btn btn-default\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Remove!</button></li>\n<li><button class=\"update\" class=\"btn btn-default\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Update!</button></li>\n\n</ul>\n\n";
	  ...
	  return "\n    "
	    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.day : stack1), depth0))
	    + "\n";
	  ...
	  return "\n    "
	    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.when : stack1), depth0))
	    + "\n";
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.reminders : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<form class='update-reminder' data-id='"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.reminder : depth0)) != null ? stack1.id : stack1), depth0))
	    + "'>\n  <fieldset>\n    <input type=\"text\" name=\"reminder[content]\" value=\"\" class='content-reminder' maxlength=\"120\" placeholder=\"Update Reminder\">\n    <input type=\"date\" name=\"reminder[day]\" value=\"\" class='date-reminder' placeholder=\"date\" required>\n    <input type=\"time\" name=\"reminder[when]\" value=\"\" class='time-reminder' placeholder=\"time\" required>\n    <input type=\"submit\" name=\"submit\" value=\"Update Reminder!\" data-id='"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.reminder : depth0)) != null ? stack1.id : stack1), depth0))
	    + "'>\n  </fieldset>\n</form>\n\n <!-- onClick=\"return emptyX()\" onClick=\"return emptyY()\" onClick=\"return emptyZ()\" -->\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class='delete-reminder'>Are you sure you would like to delete this reminder? <br>\n  <span>\n<button class=\"remove-reminder\" class=\"btn btn-default\" data-id='"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.reminder : depth0)) != null ? stack1.id : stack1), depth0))
	    + "'>Yes</button>\n<button class=\"hide-check\" class=\"btn btn-default\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.reminder : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">No</button>\n</span>\n</div>\n";
	},"useData":true});
